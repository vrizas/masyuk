        ...
        <article class="-mt-4">
            <section class="bg-base-200 rounded-2xl flex flex-col gap-3 px-5 py-3 text-sm">
                <div class="flex justify-between">
                    ...
                    <a href="#filter" class="inline-flex w-8 h-8 justify-center items-center rounded-full bg-white"><i
                        ...
                        <div class="modal-box max-w-none rounded-none h-full w-full py-5 overflow-auto relative">
                            ...
                            <div class="mt-3 flex flex-col gap-2">
                                ...
                                <div class="flex gap-2 flex-wrap">
                                    <button class="btn btn-primary btn-outline btn-sm capitalize">Menu Sarapan</button>
                                    <button class="btn btn-primary btn-outline btn-sm capitalize">Menu Makan Siang</button>
                                    <button class="btn btn-primary btn-outline btn-sm capitalize">Menu Makan Malam</button>
                                </div>
                            </div>
                            <div class="mt-4 flex flex-col gap-2">
                                ...
                                <div class="flex gap-2 flex-wrap">
                                    <div class="flex gap-3 border border-base-content px-2 py-1 rounded-lg">
                                        <p class="flex items-center">Bawang Merah <button class="flex items-center"><i
