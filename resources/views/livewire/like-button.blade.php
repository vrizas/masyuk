<div>
    @if (Auth::check())
        <button wire:click="toggleLike" class="likeButton flex justify-center items-center gap-1 lg:gap-2">
            <svg width="22" height="22" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" @if ($liked) class="liked" @endif>
                <defs>
                    <path id="heart"
    ...
    @else
        <a href="#login" class="likeButton flex justify-center items-center gap-1 lg:gap-2">
            <svg width="22" height="22" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"
